// import { cilContact, cilHouse, cilPuzzle, cilUser } from "@coreui/icons";
...
export default function WebPage() {
  ...
  return (
    <>
      {/* header section */}
      <CHeader
        className=" h-auto bg-cover text-[#043A53] w-[100vw]"
      ...
      >
        <CNav
          ...
          <div className="flex justify-between items-center w-full">
            ...
            <h1 className=" text-black font-extrabold display-6 p-2">
              @Notes_Planner
            </h1>
            ...
            <div className="md:hidden text-3xl text-[#043A53] p-3">
              ...
              <COffcanvas
                ...
                <COffcanvasHeader className="bg-slate-700">
                  <h1 className=" text-white  font-extrabold display-6 p-2">
                    @Notes_Planner
                  </h1>
                  <CCloseButton
                ...
                <COffcanvasBody className=" text-white font-mono h-min bg-slate-500">
                  <ul className=" first-letter:font-semibold">
                    <li className="md:mx-2 lg:mx-2 cursor-pointer">Home</li>
                    <li className="md:mx-2 lg:mx-2 cursor-pointer">About</li>
                    <li className="md:mx-2 lg:mx-2 cursor-pointer">Contact</li>
                  ...
                  <CButton
                    component={NavLink}
                    to="/register"
                    className="md:px-2 lg:px-4 py-1 bg-blue-600 text-[#12141D] rounded-2xl mr-2"
                  >
                    SingUp
                  </CButton>
                </COffcanvasBody>
        ...
        <div className="flex flex-wrap h-full w-full pt-16">
          <div className="text-centre self-center px-4 w-full lg:h-[230px] md:px-2 lg:px-20 md:text-left md:w-6/12 md:flex lg:flex-col md:justify-between">
            <h3 className="text-3xl md:text-4xl text-black font-bold">
              GET a platform to store your
              <span className="block text-[#043A53]">NOTES</span>
            </h3>
        ...
        />
          ...
          <div className="w-full md:w-6/12 h-full relative">
            ...
            <img
              src="./assets/ManMobile.png"
              alt="man Mobile"
              className="hidden md:inline-block md:bg-transparent md:object-contain md:h-full md:w-full bg-transparent w-full h-full "
            />
          </div>
        </div>
      </CHeader>
